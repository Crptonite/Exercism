...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if theoretical_max_power == 0:
        return "Error: Theoretical max power cannot be zero."
...
print(is_criticality_balanced(850, 600))   # False
print(is_criticality_balanced(750, 400))   # False
print(is_criticality_balanced(750, 700))   # False (product = 525000 > 500000)